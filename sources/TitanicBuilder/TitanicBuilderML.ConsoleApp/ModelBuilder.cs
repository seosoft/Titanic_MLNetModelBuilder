...
namespace TitanicBuilderML.ConsoleApp
{
    public static class ModelBuilder
    {
        private static string TRAIN_DATA_FILEPATH = @"C:\Data\train.csv";
        private static string MODEL_FILEPATH = @"../../../../TitanicBuilderML.Model/MLModel.zip";
        ...
        public static IEstimator<ITransformer> BuildTrainingPipeline(MLContext mlContext)
        {
            ...
            var dataProcessPipeline = mlContext.Transforms.Categorical.OneHotEncoding(new[] { new InputOutputColumnPair("Sex", "Sex"), new InputOutputColumnPair("Embarked", "Embarked") })
                                      ...
                                      .Append(mlContext.Transforms.Concatenate("Features", new[] { "Sex", "Embarked", "Cabin", "Name_tf", "PassengerId", "Pclass", "Age", "SibSp", "Parch", "Fare" }))
                                      .Append(mlContext.Transforms.NormalizeMinMax("Features", "Features"))
                                      .AppendCacheCheckpoint(mlContext);

            // Set the training algorithm 
            var trainer = mlContext.BinaryClassification.Trainers.SgdCalibrated(new SgdCalibratedTrainer.Options() { L2Regularization = 1E-06f, ConvergenceTolerance = 0.0001f, NumberOfIterations = 10, Shuffle = false, LabelColumnName = "Survived", FeatureColumnName = "Features" });
